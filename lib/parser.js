...
PdfParser.prototype = {
    ...
    moveTo: function (newPosition) {
        ...
        if (newPosition < this.content.length) {
            ...
            err = 'New position exceeds buffer length!';
            willie.error(err);
            throw new Error(err);
        }
    },
    ...
    getNumber: function () {
        ...
        if (tempResult) {
            ...
            if (tempResult) {
                ...
                err = 'FAIL number: Invalid number at #' + this.position;
                willie.error(err);
                throw Error(err);
            }
        }
    ...
    getName: function () {
        ...
        if (delim !== '/') {
            ...
            err = 'FAIL name: Character "' + delim + '" should be a "/" at #' + (this.position-1);
            willie.error(err);
            throw Error(err);
        }
    ...
    getBoolean: function () {
        ...
        if (temp.substr(0, 5) === 'false') {
            ...
            err = 'FAIL boolean: Invalid boolean type at #' + this.position;
            willie.error(err);
            throw new Error(err);
        }
    },
...
//        }
        ...
        finalPosition = this.position - 1;

        if (initialPosition === finalPosition) {
            err = 'FAIL literal string: Empty literal string';
            willie.error(err);
            throw new Error(err);
        }
...
//        }
        ...
        do {
            ...
            if (c === '>') {
                ...
                err = 'FAIL hexadecimal string: Invalid hexadecimal string character "' + c + '"';
                willie.error(err);
    ...
    getString: function () {
        ...
        if (this.curChar() === '(') {
            ...
            err = 'FAIL string: Invalid string at #' + this.position;
            willie.error(err);
            throw new Error(err);
        }
    },
    ...
    getArray: function () {
        ...
        if (this.curChar() !== '[') {
            ...
            err = 'FAIL array: Invalid array open delimiter "' + this.curChar() + '" at #' + this.position;
            willie.error(err);
            throw new Error(err);
        }
    ...
    getStream: function (xref) {
        ...
        if (dict.Length instanceof IndirectObjectReference) {
            ...
            err = 'FAIL stream: Invalid stream dictionary: "Length" field missing';
            willie
                .error(err)
                .dedent();
            throw new Error(err);
        ...
        if (delim !== 'stream') {
            ...
            err = 'FAIL stream: Invalid stream open delimiter "' + delim + '"';
            willie
                .error(err)
                .dedent();
            throw new Error(err);
        ...
        if (delim !== 'endstream') {
            ...
            err = 'FAIL stream: Invalid stream close delimiter "' + delim + '"';
            willie
                .error(err)
                .dedent();
            throw new Error(err);
    ...
    getNull: function () {
        ...
        if (directive !== 'null') {
            ...
            err = 'FAIL null: invalid null directive at #' + initialPosition;
            willie.error(err);
            throw new Error(err);
        }
    ...
    getIndirectObjectRef: function () {
        ...
        if (keyword !== 'R') {
            ...
            err = 'FAIL indirect object: Invalid indirect object reference keyword "' + keyword + '"';
            willie.error(err);
            throw new Error(err);
        }
    ...
    readIndirectObject: function (position, xref) {
        var
            err, objId, objRev, delim, data, value;
        ...
        if (delim !== 'obj') {
            ...
            err = 'Invalid indirect object definition open delimiter "' + delim + '"';
        ...
        if (delim !== 'endobj') {
            ...
            err = 'Invalid indirect object definition close delimiter "' + delim + '"';
    ...
    getDictionary: function () {
        ...
        if (delim !== '<<') {
            ...
            err = 'FAIL dictionary: Invalid dictionary open delimiter "' + delim + '"';
            willie.error(err);
            throw Error(err);
        }
        ...
        if (this.eof()) {
            ...
            err = 'FAIL dictionary: Dictionary has no closing delimiter';
            willie.error(err);
            throw new Error(err);
        }
    ...
    readXRef: function (position) {
        ...
        if (delim !== 'xref') {
            ...
            err = 'Invalid xref directive "' + delim + '"';
    ...
    getTrailer: function (position) {
        ...
        if (delim !== 'trailer') {
            ...
            err = 'Invalid trailer delimiter "' + delim + '" at #' + position;
    ...
    findXRef: function () {
        ...
        do {
            ...
            if (this.content.length - curPos > LIMIT) {
                ...
                err = 'Could not find startxref - not a valid PDF';
...
//    },
    ...
    getVersion: function () {
        ...
        if (match && match[1] && match[2]) {
            ...
            err = 'Invalid PDF signature "' + versionStr + '"';
