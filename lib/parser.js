...
var
    ...
    IndirectObjectRef = require('./objects/indobjref'),
...
//        }
    ...
    getStream: function () {
        ...
        result = new PdfStreamObject(dict, this.content.slice(this.position, this.position + dict.Length));
    ...
    getIndirectObjectRef: function () {
        ...
        return new IndirectObjectRef(objId, objRev);
    },

    readIndirectObject: function (position) {
        var
            objId, objRev, delim, data;
        ...
        if (delim !== 'obj') {
            throw new Error('Invalid indirect object definition open delimiter');
        }
        ...
        if (delim !== 'endobj') {
            throw new Error('Invalid indirect object definition close delimiter');
        }
